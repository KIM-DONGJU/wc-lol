          ...
          <template #header>
            <div class="d-flex justify-space-between align-center">
              <p class="font-weight-bold text-h5">
                {{ matchGroup?.group_name }} 참가자 검색 및 등록
              </p>
      ...
      <div class="wrap-today-participant">
        <div class="wrap-tables">
          <p class="font-weight-bold text-h6">
            {{ matchGroup?.group_name }} 참가자 목록 ({{ selectedGroupMembers.length }}명)
          </p>
          <div
            ...
            >
              ...
              >
                ...
                <div class="tier-table-right d-flex flex-column">
                  <p
                    v-for="(score, position) in getMainPositionAndSubPosition(selectedMembers)"
                    :key="position"
                    class="flex-1-1"
                  >
...
const getMainPositionAndSubPosition = (groupMember: GroupMember) => {
